...
esmvaltool run --skip-nonexistent=True --check_level=relaxed --offline=True ~/decadal-prediction-data-preparation/esmvaltool-recipes/recipe_s20_cmip6_cesm1_1_cam5_cmip5_autogen.yml
...
esmvaltool run --skip-nonexistent=True --check_level=relaxed --offline=True ~/decadal-prediction-data-preparation/esmvaltool-recipes/recipe_s20_cmip6_hadgem3_gc31_mm_autogen.yml
...
esmvaltool run --skip-nonexistent=True --check_level=relaxed --offline=True ~/decadal-prediction-data-preparation/esmvaltool-recipes/recipe_s20_cmip6_mpi_esm1_2_hr_autogen.yml
